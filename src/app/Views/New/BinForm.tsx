    ...
    return (
        ...
        >
                ...
                >
                    ...
                    >
                        <Text style={[styles.intentTitle, {color: textColor}]}>Zostanie dodany element:</Text>
                        <ElementCard type={props.type} imageEnabled={false} binStatus={status} timestamp={new Date()} addedBy={"FIXME: tu dodać nazwe aktualnego użytkownika"} />
                        <View
                            style={{
                                marginTop: 36,
                                flexDirection: "row",
                        ...
                        >
                            <Text style={{color: textColor, width: 64, textAlign: "center"}} numberOfLines={1}>Anuluj</Text>
                            <Text style={{color: textColor, width: 64, textAlign: "center"}} numberOfLines={1}>Dodaj</Text>
                        </View>
                    </View>
                </View>
        </View>
